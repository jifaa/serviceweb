...
// ─────────────────────────────────────────────────────────────────────────────
// Advanced: Motion Values Hook (for external use)
// ─────────────────────────────────────────────────────────────────────────────

/**
 * useStackingMotionValues
 *
 * Provides raw Framer Motion values for a stacking card, useful when
 * you need to drive custom animations in parallel with the stacking effect.
 *
 * @param cardRef - Ref to the sticky card element
 * @param isLast - Whether this is the last card (no exit animation)
 */
export function useStackingMotionValues(
  ...
  return { scrollYProgress, scale, opacity, blur, brightness, y };
}
...
// ─────────────────────────────────────────────────────────────────────────────
// Demo: Stacking Sections Showcase
// ─────────────────────────────────────────────────────────────────────────────
...
const demoCards = [
  {
    ...
    accentColor: "var(--color-surface-violet-soft)",
  },
  {
    ...
    bgColor: "var(--color-canvas-soft)",
    accentColor: "var(--color-surface-teal-mid)",
  },
  {
    title: "Desain & Pengembangan",
    subtitle: "Langkah 03",
    description:
      "Merancang UI/UX yang modern dan intuitif, dilanjutkan implementasi kode dengan standar kualitas tinggi. Progress dilaporkan secara berkala.",
    bgColor: "var(--color-canvas)",
  ...
  },
  {
    ...
    subtitle: "Langkah 04",
    description:
      "Deployment ke server production, konfigurasi domain & SSL, sesi pendampingan awal, dan dukungan pasca peluncuran.",
    bgColor: "var(--color-canvas-soft)",
    accentColor: "var(--color-surface-violet-soft)",
  },
];
  ...
  return (
    <StackingContent>
      ...
      >
        ...
        {/* Subtitle */}
        <p
          className="text-micro uppercase tracking-widest mb-4"
        ...
        {/* Title */}
        <h2
          className="text-display-xxl mb-6"
          style={{
...
export function StackingSectionsDemo() {
  return (
    <main className="flex-1">
      ...
      >
        <div className="text-center max-w-3xl">
          ...
          <p
            ...
            style={{ color: "var(--color-ink-mute)" }}
          >
            Scroll down to see the card stacking effect in action. Each section
            smoothly stacks on top of the previous one.
          </p>
          <div className="mt-12">
            <div
      ...
      >
        <div className="text-center max-w-3xl">
          ...
          >
            The stacking effect creates a smooth, engaging scroll experience
            that keeps users focused with dynamic visual feedback.
          </p>
        </div>
      </section>
    </main>
