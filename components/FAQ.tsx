    ...
    >
      ...
      >
        ...
        <div className={`flex-shrink-0 w-10 h-10 neu-inset flex items-center justify-center text-[var(--neu-foreground-muted)] transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? 'text-[var(--neu-accent)]' : ''}`}>
          <svg
            className={`w-5 h-5 transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? "rotate-180 text-[var(--neu-accent)]" : ""
              }`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
...
const faqs = [
  {
    ...
    answer:
      "Waktu pengerjaan bervariasi tergantung kompleksitas project. Landing page sederhana biasanya memakan waktu 5-9 hari, sedangkan aplikasi web kompleks membutuhkan waktu 2-4 minggu.",
  },
  {
    question: "Apakah website yang dibuat sudah responsive?",
    answer:
      "Kami akan selalu berusaha agar website dan aplikasi web yang saya buat selalu dioptimalkan untuk tampil sempurna di berbagai perangkat (desktop, tablet, dan smartphone).",
  },
  {
    question: "Apakah saya perlu menyediakan desain sendiri?",
    answer:
      "Jika Anda sudah punya desain sendiri atau referensi desain, saya bisa mengimplementasikannya. Jika belum, saya juga bisa membantu desain sesuai kebutuhan.",
  },
  {
    question: "Bagaimana dengan maintenance setelah website selesai?",
    answer:
      "Saya memberikan garansi perbaikan bug secara gratis dalam rentang waktu tertentu setelah website dideploy. Perawatan berkala juga bisa disepakati bersama.",
  },
  {
    question: "Teknologi apa saja yang digunakan?",
    answer:
      "Saya biasa menggunakan ekosistem JavaScript/TypeScript modern seperti Next.js, React, Tailwind CSS, serta pustaka pendukung performa tinggi.",
  },
  {
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-28 lg:self-start lg:h-fit z-10">
          <div ref={headerRef} className="lg:pr-6">
            ...
            <p className="text-body-lg text-[var(--neu-foreground)] opacity-80">
              Beberapa jawaban atas pertanyaan yang sering diajukan.
            </p>
          </div>
        </div>
